...
_(listed in alphabetical order of the model/algorithm/method names)_
 ...
 <!--  <p style="margin-left:8%;margin-top: -35px;"><em> (A graph neural network with spectral filter)</em></p> -->
   ...
   <ul>
    <li><strong>  Regularized Wasserstein Kernels (RWK): </strong><a href="https://github.com/wokas36/RWK">https://github.com/wokas36/RWK</a> <a href="https://arxiv.org/pdf/2110.02554.pdf"> (paper link)</a><br></li> 
    <li><strong>  Declarative Framework for Network Analytics (Rogas): </strong><a href="https://github.com/CornucopiaRG/Rogas">https://github.com/CornucopiaRG/Rogas</a> <a href="https://dl.acm.org/doi/10.14778/3007263.3007309"> (paper link)</a><br></li>
   </ul>
