...
<div class="col-sm-19 clearfix">
 <div class="well">
  ...
  <img src="{{ site.url }}{{ site.baseurl }}/images/propic/project-knowledge-tracing.jpg" class="img-responsive" width="40%" style="float:left; Padding-top: -10px;Padding-right: 15px;" /> Knowledge tracing is an important task in a wide range of applications in education, such as massive open online courses (MOOCs), intelligent tutoring systems, educational games, and learning management systems. It models dynamics in a student's knowledge states in relation to different learning concepts through their interactions with learning activities. Questions of interest include: (1) How to develop robust, efficient and scalable solutions for shortest-path related problems on large networks with possibly billions of vertices? (2) How to handle dynamics of networks, i.e., topological structure changes caused by node and edge insertions and deletions? (3) What kinds of the theoretical properties can we gurantee in our soltions?
