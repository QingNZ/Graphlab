...
_(listed in alphabetical order of the model/algorithm/method names)_
 ...
 <!--  <p style="margin-left:8%;margin-top: -35px;"><em> (A graph neural network with spectral filter)</em></p> -->
   ...
   <img src="../images/letters/letter-r.png" alt="R" width="50">
   <ul>
    <li><strong>  Regularized Wasserstein Kernels (RWK): </strong><a href="https://github.com/wokas36/RWK">https://github.com/wokas36/RWK</a> <a href="https://arxiv.org/pdf/2110.02554.pdf"> (paper link)</a></li> 
