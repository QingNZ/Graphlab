...
The figure below shows that our <a href="https://github.com/mufarhan/highway_labelling"> Highway Labelling (HL)</a> technique can construct distance labelling linearly in terms of the number of landmarks, which confirms its scalability, while answering distance queries on large networks efficiently (on the scale of billions).
